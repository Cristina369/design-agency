    ...
    <>
        <section className='flex flex-row-reverse p-20 mobile:flex-col mobile:p-4 desktop:flex-row-reverse desktop:p-20'>
            ...
            <div className='w-8/12 pl-28 pr-16 pt-24 mobile:w-full mobile:p-4 desktop:w-8/12 desktop:pr-16 desktop:pl-28 desktop:pt-24'>
               ...
               <p className=' text-secondary text-lg font-medium p-4'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos sequi itaque doloremque. Obcaecati iusto porro eius cupiditate magnam ea fuga, architecto non praesentium, soluta laboriosam temporibus reiciendis, adipisci sed?</p>
               ...
               <div className='flex flex-row-reverse mobile:flex-col-reverse desktop:flex-row-reverse'>
                    <div className='flex flex-col w-7/12 pl-10 mobile:w-full desktop:w-7/12'>
                        ...
                        <p className=' text-secondary text-lg font-medium'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit quis maxime voluptatem exercitationem similique mollitia sunt error perspiciatis odit sint, est totam reiciendis in ad quisquam cum accusantium aperiam.</p>
                    </div>
