  ...
  return (
    <>
      <section className='my-20'>
        {portofolio.slice(0,2).map((val, index, attribute) =>(
          index % 2 ?(
        ...
        <div className='ml-20 mobile:disNone desktop:disBtn desktop:ml-20 desktop:-mt-28'>
          <Btn title={'Mai mult'} link={'/portofolio'}/>
        </div>
      </section>
    </>
  )
